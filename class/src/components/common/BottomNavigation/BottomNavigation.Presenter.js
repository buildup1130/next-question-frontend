import { HomeIcon,BookIcon, CheckIcon, ShelfIcon, HistoryIcon } from "@/utils/SvgProvider";
import {NavContainer, Icon, NavItem, NavTitle} from "./BottomNavigation.Styles"
    ...
    return (
        <NavContainer>
          ...
          <NavItem 
            ...
            onClick={() => props.handleNavigation('/check')}
          >
            <Icon>
              <CheckIcon></CheckIcon>
            </Icon>
